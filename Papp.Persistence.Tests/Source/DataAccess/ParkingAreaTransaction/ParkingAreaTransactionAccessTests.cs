...
public class ParkingAreaTransactionDataAccessTests
{
    ...
    public async Task GetAllAsync()
    {
        ...
        Func<IBaseSpecification<ParkingAreaTransaction>?, IList<ParkingAreaTransaction>, Task> runner = async (filter, expected) =>
        {
        ...
        await runner(new Specification<ParkingAreaTransaction>(e => e.ParkingAreaId.Equals(2)), mockData.Where(e => e.ParkingAreaId.Equals(2)).ToList());
        await runner(new Specification<ParkingAreaTransaction>(e => e.ParkingAreaId.Equals(3)), new List<ParkingAreaTransaction> { mockData[2] });
        await runner(new Specification<ParkingAreaTransaction>(e => e.ParkingAreaId.Equals(-3)), new List<ParkingAreaTransaction>());
    }
    ...
    {
        // Implementation of the test
        Func<IBaseSpecification<ParkingAreaTransaction>, ParkingAreaTransaction?, Task> runner = async (filter, expected) =>
        {
        ...
        await runner(new Specification<ParkingAreaTransaction>(e => e.Id.ToString().Equals("")), null);
        await runner(new Specification<ParkingAreaTransaction>(e => e.Id.ToString().Equals("   ")), null);
        await runner(new Specification<ParkingAreaTransaction>(e => e.Id.ToString().Equals("129d6427-adf2-4746-a33f-cfc60a51e4e2")), null);
        await runner(new Specification<ParkingAreaTransaction>(e => e.Id.ToString().Equals("029d6427-adf2-4746-a33f-cfc60a51e4e2")), mockData[1]);
        await runner(new Specification<ParkingAreaTransaction>(e => e.ParkingAreaId.Equals(-1)), null);
        await runner(new Specification<ParkingAreaTransaction>(e => e.ParkingAreaId.Equals(3)), mockData[2]);
    }
