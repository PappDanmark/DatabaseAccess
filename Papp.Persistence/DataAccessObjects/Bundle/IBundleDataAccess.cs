...
public interface IBundleDataAccess : IGenericDataAccess<Bundle>
{
    ...
    /// </summary>
    /// <param name="id">The id of the Bundle which needs to be updates.</param>
    ...
    /// <returns>The new modified Bundle entity, or null if the a Bundle for the provided id doesn't exist.</returns>
