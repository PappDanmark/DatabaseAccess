...
public interface IChargerDataAccess : IGenericDataAccess<Charger>
{
    ...
    /// </summary>
    /// <param name="id">The id of the Charger which needs to be updated.</param>
    ...
    /// <returns>The new modified Charger entity, or null if a Charger for the provided id doesn't exist.</returns>
