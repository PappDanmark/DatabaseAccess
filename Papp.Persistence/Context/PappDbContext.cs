...
public partial class PappDbContext : DbContext
{
    ...
    public virtual DbSet<Sensor1> Sensors1 { get; set; } = null!;
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Country>(entity =>
        {
            ...
            entity.Property(e => e.Iso3166Alpha2).HasColumnName("iso-3166-alpha-2");

            entity.Property(e => e.Iso3166Alpha3).HasColumnName("iso-3166-alpha-3");
        ...
        modelBuilder.Entity<ParkingArea>(entity =>
        {
            ...
            entity.Property(e => e.PappId).HasColumnName("papp_id");
