...
namespace Papp.Persistence
{
    public partial class PappDbContext : DbContext
    {
        ...
        public virtual DbSet<ParkingAreaOccupancy> ParkingAreaOccupancies { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ParkingAreaOccupancy>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("parking_area_occupancy");
